   ...
   return (
      <View className='flex-col px-4 mb-14 items-center'>
         <View className='flex-row gap-3 items-start'>
            <View className='flex-1 flex-row justify-center items-center'>
               ...
               <View className='flex-1 justify-center ml-3 gap-y-1'>
                  <Text numberOfLines={1} className='text-white font-psemibold text-sm'>Some title here</Text>
                  <Text numberOfLines={1} className='text-gray-100 font-pregular text-xs'>andoHenri</Text>
               </View>
            </View>
            <View className='pt-2'>
         ...
         {play ? (
            ...
            >
               <Image source={images.thumbnail} resizeMode='cover' className='w-full h-full rounded-xl mt-3' />
